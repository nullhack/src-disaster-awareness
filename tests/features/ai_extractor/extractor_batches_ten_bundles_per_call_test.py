...
@given(bundle_count=st.integers(min_value=0, max_value=100), expected_calls=st.integers())
@settings(max_examples=5, deadline=None)
def test_ai_extractor_batches_bundles_per_call(bundle_count: int, expected_calls: int) -> None:
